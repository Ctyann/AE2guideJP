...
I/Oポートを使うと、[ストレージセル](../items-blocks-machines/storage_cells.md)と
...
*   I/Oポートは、セルが空になった時、満杯になった時、または処理完了時にセルを出力スロットへ移動するよう設定できます。
...
I/Oポートは以下の[アップグレード](upgrade_cards.md)に対応しています。
