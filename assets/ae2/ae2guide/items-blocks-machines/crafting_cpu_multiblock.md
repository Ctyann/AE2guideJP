...
これらはプレイヤー、オートメーション（エクスポートバスやインターフェース）またはその両方からのリクエストを処理するように設定できます。
...
これにより、高速で処理するマシンに対応できます。例として、<ItemLink id="molecular_assembler" />に囲まれたパターンプロバイダーが、単一のアセンブラーが処理できる速度を超えて材料をプッシュし、周囲のアセンブラー間で材料バッチを分配することができます。
