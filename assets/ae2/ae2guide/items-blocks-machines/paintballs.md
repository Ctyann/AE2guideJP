...
ペイントボールは、[ケーブル](cables.md)、羊毛、テラコッタ、ガラス、コンクリートのような着色可能なブロックを塗るために
<ItemLink id="color_applicator" />で使用されます。また、<ItemLink id="matter_cannon" />で発射して小さな塗料の飛沫を撃ち出すこともできます。
...
通常のペイントボールと同じように機能しますが、<ItemLink id="matter_cannon" />で発射した飛沫が発光します。
一種のフレアガンのような用途に使えます。

## レシピ

グロウストーンダストの周囲にペイントボール8個
