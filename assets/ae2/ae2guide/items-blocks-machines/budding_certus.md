...
芽生えたケルタスブロックには、完璧な、傷ついた、欠けた、壊れかけの4つの段階があります。これらは、HWYLA、Jade、The One Probeなどのモッド（またはf3画面）を使用して最も簡単に識別できます。

傷ついた、欠けた、壊れかけの芽生えたケルタスでは、芽が成長するたびに、芽生えたブロックが1段階劣化する可能性があり、最終的には普通の<ItemLink id="quartz_block" />に変わります。
...
傷ついた、欠けた、壊れかけの芽生えたケルタスは、前の段階の芽生えたブロック（または<ItemLink id="quartz_block" />）を水に投げ込み、1つ以上の<ItemLink id="charged_certus_quartz_crystal" />と一緒にクラフトすることで作成できます。
